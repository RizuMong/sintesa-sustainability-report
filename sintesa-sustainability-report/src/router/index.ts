...
export const router = createRouter({
  ...
  routes: [
    ...
    { path: '/evaluate-gri-quantitative/:id', name: 'evaluate-detail', component: EvaluateDetailPage, meta: { nextTheme: true } },
    { path: '/master-key-indicator-quantitative', name: 'mki-list', component: MasterKeyIndicatorListPage },
    { path: '/master-key-indicator-quantitative/:id', name: 'mki-detail', component: MasterKeyIndicatorDetailPage, meta: { nextTheme: true } },

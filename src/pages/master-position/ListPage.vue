          ...
          <MpTable>
            <MpTableHead>
              <MpTableRow>
                ...
                <MpTableCell scope="col">Domain</MpTableCell>
                <MpTableCell scope="col">Role</MpTableCell>
...
function goToCreate() {
  router.push('/master-position/detail')
}

function goToDetail(row: MasterPosition) {
  router.push({ path: '/master-position/detail', query: { id: row.id } })
}
</script>
